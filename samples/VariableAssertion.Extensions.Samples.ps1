...
Add-AssertItem -Name "physicalPath" -Value "C:\inetpub\wwwroot\Demo3\" -Type Folder
Add-AssertItem -Name "applicationPool" -Value "DefaultAppPool" -Type "Application Pool" -ErrorPreference Warning
Add-AssertItem -Name "siteName" -Value "Default Web Site\Demo" -Type WebSite
Add-AssertItem -Name "CustomPath" -Value "C:\inetpub\wwwroot\Demo3\index.html" -Type File
